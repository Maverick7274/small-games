...
wn.title("Pong by Neelanjan Mukherji")
...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Player A: 0  Player B: 0", align="center", font=("BigBlue Terminal 437TT Nerd Font Complete", 24, "normal"))
...
while True:
    ...
    if ball.xcor() > 620:
        ...
        score_a += 1
        pen.clear()
        pen.write("Player A: {}  Player B: {}".format(score_a, score_b), align="center", font=("BigBlue Terminal 437TT Nerd Font Complete", 24, "normal"))
